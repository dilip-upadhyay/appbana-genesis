...
| Prompt Template Registry v0.1 | 1 wk | `packages/ai-application-agent/prompts/index.json` + versioning enforcement tool; deleting a version referenced by any provenance record fails CI; `promptTemplateHash` reproducible across runs. | ⏳ | _TBD_ |
